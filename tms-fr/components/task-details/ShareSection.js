...
const ShareSection = ({ taskData }) => {
    ...
    return (<form onSubmit={handleSubmit(onSubmit)}>
        <div className="p-5 border-none mb-3">
            ...
            <Button style={{ float: "left" }} tooltip={buttonTooltip} icon="pi pi-link" onClick={() => copyUrl()} className="p-button-secondary p-button-outlined p-button-rounded p-button-sm" />
